...
public class LeafLoadingView extends View {
    ...
    // 叶子飘动一个周期所花的时间
    private static final long LEAF_FLOAT_TIME = 6000;
    // 叶子旋转一周需要的时间
    private static final long LEAF_ROTATE_TIME = 3000;
...
//    private int mOuterWidth, mOuterHeight;
    ...
    public LeafLoadingView(Context context, AttributeSet attrs) {
        ...
        mLeftMargin = ScreenUtil.b(context, LEFT_MARGIN);
        mRightMargin = ScreenUtil.b(context, RIGHT_MARGIN);
...
//            canvas.drawRect(mOrangeRectF, mOrangePaint);
    ...
    private void getLeafLocation(Leaf leaf, long currentTime) {
        ...
        leaf.x = getLocationY(leaf);
        leaf.y = mProgressWidth * fraction;
    }
    ...
    private int getLocationY(Leaf leaf) {
        ...
        return (int) (a * Math.sin(w * leaf.y)) + mArcRadius * 2 / 3;
    }
...
//        mProgressWidth = mTotalWidth - mLeftMargin - mRightMargin;
        mProgressWidth = mTotalHeight;
//        mArcRadius = (mTotalHeight - 2 * mLeftMargin) / 2;
        mArcRadius = mTotalWidth / 2;
...
//        mOuterDestRect = new Rect(0, 0, mTotalWidth, mTotalHeight);
    ...
    private class LeafFactory {
        private static final int MAX_LEAFS = 300;
